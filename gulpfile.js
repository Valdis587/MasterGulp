...
import { menu } from "./gulp/tasks/menu.js";
...
function watcher() {
   ...
   gulp.watch(path.watch.menu, menu);
...
const mainTasks = gulp.series(fonts, gulp.parallel(copy, html, mainCss, js, lib, menu, scss, images));
